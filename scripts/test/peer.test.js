...
describe('Test peer functionality', () => {
    ...
    test('Test peer version messaging [4]', () => {
        ...
        expect(output1.slice(38, 96)).toStrictEqual(Buffer.from("476000000000010000000000000000000000000000000000ffff000000000000010000000000000000000000000000000000ffff000000000000", "hex"));
